...
interface SpecifiedCommunityTableViewProps {
    sectionTitle: string;
...
const SpecifiedCommunitySectionTableView: React.FC<SpecifiedCommunityTableViewProps> = ({
    sectionTitle,
    topIdeas,
    isDashboard,
    showCustomFilter,
    ...
    return (
        <Container className='system' id='hanging-icons' style={{paddingLeft:'0rem', paddingRight:'0rem'}}>
                            ...
                            ? topIdeas.map((idea, index) => {
                                ...
                                return doesIdeaPassFilter(idea) ?
                                    <tr key={idea.id}>
                                        ...
                                        <td className='text-center align-middle'>  
                                            <Card.Link href={idea.state === 'PROPOSAL' ? `/proposals/${idea.id}` : `/ideas/${idea.id}`}>
...
export default SpecifiedCommunitySectionTableView;
