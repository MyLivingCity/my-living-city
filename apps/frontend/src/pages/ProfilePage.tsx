...
import LoadingSpinner from "@components/ui/misc/LoadingSpinner";
...
const ProfilePage: React.FC<ProfilePageProps> = () => {
  ...
  if (isError) {
    return <div className="wrapper">{JSON.stringify(error)}</div>;
  }
  return (
    <div className="wrapper">
      {user ? (
        ...
        <p>
          Error trying to load personal profile. Please relogin and try again.
        </p>
      )}
    </div>
  );
