...
export function makeUpload(folderName) {
  // TODO
  // const upload = multer({
  //   storage: multerS3({
  //     s3: client,
...
export async function uploadImage(folderName, fileName, fileContent) {
  // TODO
  // try {
  //   const params = {
  //     Bucket: AWS_S3_BUCKET_NAME,
 ...
 */
export async function accessImage(imageFolder, imageKey) {
  // TODO
  // try {
 ...
 */
export async function deleteImage(imageFolder, imageKey) {
  // TODO
  // try {
